...
dashboard:reset(); dashboard:render({ status = "MINING", slice = 50, distance = 100, fuel = 900, loot = 4, capacity = 13, torches = 20, filler = 64, ores = 8, veins = 2, unloads = 1, ore = "Diamond Ore" })
assert(state.rows[1]:find("RalfieOS Miner") and state.rows[3]:find("50%%") and state.rows[8]:find("Diamond Ore"))
