local tests = {
  ...
  "pocket_ui_tests.lua", "pocket_main_tests.lua", "pocket_update_batch_tests.lua", "tunnel_pattern_tests.lua", "tunnel_pattern_observation_tests.lua",
  "tunnel_dispatch_tests.lua",
}
